...
April, 2009
-------------------------------------------------------------------------
In the process of developing your game you should start with a working skeleton,
and add on to it. If you have the seperate logical operations in seperate functions
this is much easier to do. Here we add pictures, and as a result we need to compute
what direction the movement was done in.
'''
