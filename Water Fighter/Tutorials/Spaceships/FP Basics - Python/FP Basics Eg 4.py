...
April, 2009
-------------------------------------------------------------------------
This forth version shows the implementation of classes to manage the complexity
of the program. Although the overall complexity of the program seems to have increased
the mainline is greatly simplified and the complexity of each ship is encapsulated
within classes. 
'''
