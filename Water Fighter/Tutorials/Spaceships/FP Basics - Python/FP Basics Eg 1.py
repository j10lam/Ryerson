...
April, 2009
-------------------------------------------
This program is a simple demonstration of implementing a main game loop in Python.
You can see how the Python code corresponds to the original plan.
...
while running:
    ...
    if goodX > badX +5:                 # move bad guy - this is my very simple AI
        badX+=5                    
    elif goodX < badX-5:   
        badX-=5        
    if goodY > badY +5:
